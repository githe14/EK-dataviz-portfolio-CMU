...
Please click **[The Attention Economy: How Streaming Changed the Songwriting](https://carnegiemellon.shorthandstories.com/the-attention-economy-of-the-music-industry/index.html)** or copy and paste the link below to see my presentation of the final project!
...
Reflecting on the entire progress of my project, I believe the most enjoyable and challenging part was creating a compelling story within the data. While data availability is often limited in the music industry, the more difficult challenge was finding meaningful insights that attract or convince the readers from the data I had. My initial dataset for Idea A was massive, but the story it told (streaming is growing) was too obvious. Applying "cause and effect" thinking was an important moment. I realized that consumption behavior and trends were the cause, and I needed to focus on the effect, which is the changes to the song itself. As a student concentrating on the entertainment industry, I was already aware of these trends, but validating these known facts with actual data was a valuable lesson for me as well. If I could revisit this project, I would love to expand on the "Call to Action," specifically regarding the support of artists outside of streaming. It would be fascinating to explore why physical media isn't dead and analyze the financial incentives of physical formats vs. streaming to add an extra layer of depth to the narrative.

Technically, this final project took a very different approach to data visualization compared to other works I completed for the class. This was the only time I used AI and Python instead of Tableau, although I first started with Tableau. I found that a dark theme was essential in creating Shorthand Story to effectively highlight the trendlines, which are the key visual elements of my two main charts. It was a difficult choice, and using AI’s help was a new journey for me, but I was genuinely impressed by the level of detail it offered in generating the codes for me. I was especially surprised by how detailed it can follow the instructions I requested, such as creating annotations, changing color palettes, and generating the separate codes for the six-step progressive line charts. In fact, this was a demonstration of why people are discussing whether AI will replace designers. Being able to utilize AI's help with data visualization was a meaningful learning experience, as it made me want to explore the capabilities of AI and understand how to effectively leverage this powerful tool.
